    ...
    public static class ServicesSetup
    {
        ...
        private static string GetDatabaseConnectionString(ConfigurationManager configuration)
        {
            ...
            try
            {
                ...
                // Connection string migrated to NpgsqlConnectionStringBuilder below - removed partialConnString = $"Server={dbSecrets.Host},{dbSecrets.Port}; Initial Catalog=BobsUsedBookStore;MultipleActiveResultSets=true; Integrated Security=false;TrustServerCertificate=True\r\n";
